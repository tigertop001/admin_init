...
const API_URLS = {
  ...
  ADD: {
    mock: "/mock/6740733ee0641e1205ae5b92/member/membership/list",
    real: "/api/v1/tenant/sysmanager/carousel/create"
  },
  EDIT: {
    mock: "/mock/6740733ee0641e1205ae5b92/member/membership/list",
    real: "/api/v1/tenant/sysmanager/carousel/update"
  },
  DEL: {
    mock: "/mock/6740733ee0641e1205ae5b92/member/membership/list",
    real: "/api/v1/tenant/sysmanager/carousel/delete"
  },
  ED: {
    mock: "/mock/6740733ee0641e1205ae5b92/member/membership/list",
    real: "/api/v1/tenant/sysmanager/carousel/switch"
  }
} as const;
...
export const edApi = data => {
  return http.request<Result>("post", getUrl("ED"), { data });
};
export const api = {
  list: listApi,
  add: addApi,
