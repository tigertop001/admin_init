...
const API_URLS = {
  LIST: {
    ...
    real: "/api/v1/tenant/usercenter/level/userLevelList"
  },
  ADD: {
    mock: "/mock/6740733ee0641e1205ae5b92/member/membership/list",
    real: "/api/v1/tenant/usercenter/level/userLevelDeal"
  },
  REC: {
    mock: "/mock/6740733ee0641e1205ae5b92/member/membership/list",
    real: "/api/v1/tenant/usercenter/level/userLevelDealLog"
  }
} as const;
...
// 编辑
export const recApi = data => {
  return http.request<Result>("post", getUrl("REC"), { data });
};
export const api = {
  list: listApi,
  add: addApi,
